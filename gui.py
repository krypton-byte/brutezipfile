...
def zipFile():
    global fileZip
    fileZip = filedialog.askopenfilename(initialdir="/home/krypton-byte/brutezip", title="File Manager", filetypes=(("Zip","*.zip"),("Files","*.*")))
    print(fileZip)
def wordlist():
    global wordlis
    wordlis = filedialog.askopenfilename(initialdir="/home/krypton-byte/brutezip", title="File Manager", filetypes=(("Plain Text","*.txt"),("Files","*.*")))
    print(wordlis)
def main():
    win=tk.Tk()
